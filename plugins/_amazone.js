...
const ams = fs.readFileSync('src/image/amazine.mp3')
        ...
        if (match[1] === '') {
            amazone.commands.map(
                async (command) =>  {
                    ...
                    if (!command.desc == '' && !cmmand.usage == '' && command.warn == '') {
